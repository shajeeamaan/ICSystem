<%-- 
    Document   : dashboard
    Created on : 20-Apr-2016, 20:44:46
    Author     : Rockit Bat
--%>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#" align="center">Inventory Control System</a>
                </div>
            ...
            <div class="row">
                <div class="col-sm-3 col-md-2 sidebar">
                    <ul class="nav nav-sidebar">
                        <li><a href="Admin.jsp">Home</a></li>
                        <li class="active"><a href="#">Inventory Details<span class="sr-only">(current)</span></a></li>
