<%-- 
    Document   : dashboard
    Created on : Dec 13, 2016, 22:16:40
    Author     : Rockit Bat
--%>
            ...
            <div class="row">
                <div class="col-sm-3 col-md-2 sidebar">
                    <ul class="nav nav-sidebar">
                        ...
                        <li class="active"><a href="#">Supplier Details<span class="sr-only">(current)</span></a></li>
                ...
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main"> 
                    ...
                    <h2 class="sub-header">Supplier Details</h2>
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped">
                            ...
                            <td><%=st.getString("suptell")%></td>
                            <td><%=st.getString("supeml")%></td>
                            <td>
